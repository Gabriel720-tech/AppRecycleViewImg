...
import com.example.apprecyclerviewlmg.databinding.ItemAndroidBinding
...
class AdapterAndroid (val listaAndroid: List<Android>, val context: Context)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterAndroid.ViewHolder {
